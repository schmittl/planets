...
class Earth {
  ...
  createOrbit() {
    ...
    line.rotation.x = Math.PI / 2; // rotate by 90 degrees
    return line;
  }
  ...
  update(delta) {
    ...
    this.earthMesh.position.x = this.orbitRadius * Math.sin(this.counter);
    this.earthMesh.position.z = this.orbitRadius * Math.cos(this.counter);
  }
}
